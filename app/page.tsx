...
export default function Home() {
  ...
  return (
    <main>
      ...
      <footer><a className="brand" href="#top"><img className="brand-logo" src="/hire-logo.png" alt="hire Lab. 標誌" /> hire Lab.</a><p>Handmade cords & worldly objects.</p><div><a href="https://www.instagram.com/hireee__/" target="_blank" rel="noreferrer">Instagram</a><a href="https://line.me/ti/g2/xtWfrPpSaWsik7s0P4Tp1-nQCUC5nC1jVEOL3A?utm_source=invitation&utm_medium=link_copy&utm_campaign=default" target="_blank" rel="noreferrer">LINE</a></div><small>© 2026 hire Lab. Prototype website.</small></footer>
